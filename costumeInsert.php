...
$color = $_POST['color'];
$gender = $_POST['gender'];
if (isset($_POST['size_sh'])) $size = $_POST['size_sh'];
if (isset($_POST['size_c'])) $size = $_POST['size_c'];
...
$sql = "Insert into cloth (c_name, color, gender, size, pic, ct_id, price, stock) Values('$c_name','$color','$gender','$size','$file', $category, $price, $stock)";
