...
<body onload="defaultElements()">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <h3 align="right" id="h_3"><a id="h_3" href="costume.php?username=<?PHP echo $username; ?>">Back</a></h3>
            </div>
        </div>
    </div>
    <?PHP
    ...
    // show cart
    if ($amount == 0) {
        echo "<p align='center' id='p2'>ไม่มีสินค้าในตะกร้า !</p>";
    } else {
        $sql = "select * from cart inner join cloth on cart.c_id = cloth.c_id and cart.username = '$username'" or die("Error:");
        // $sql = "select * from cart inner join cloth on cart.c_id = cloth.c_id and cart.username = '$username'" or die("Error:" . mysqli_error());
    ...
    ?>
        ...
        <table width="1150" align="center">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <font id="a3"> <?PHP echo $rs['color']; ?> </font>
                    </td>
                    <td>
                    ...
                    <td><a href="delUserOrder.php?cart_id=<?PHP echo $rs['cart_id']; ?>&amount=<?PHP echo $rs['amount']; ?> " id="a1">Delete</td>
                </tr>
            <?PHP
        ...
        <table align="center">
            <tr height="70">
                <td colspan="2">
                    <p id="p3" style="font-weight: bold;">Pleas Enter Payment Number:</p>
                </td>
            </tr>
        </table>
        <br>
            ...
            <tr>
                ...
                <td align="left" id="space">
                    <form name="cancel" action="cancelOrder.php" method="GET">
                        <input type="hidden" name="username" value="<?PHP echo $username; ?>" />
                        <button type="submit" name="cancel" class="btn btn-danger btn-lg" style="width:120px">Cancel</button>
                    </form>
                </td>
            </tr>
        </table>
