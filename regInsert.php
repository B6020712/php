...
$email = $_POST['email'];
// check username
$sql_select = "select * from user where username='$userName'" or die("Error:");
...
Values('$userName','$passWord','$name','$email','Customer')";
    ...
    echo "<script>alert('The UserName already exist, Please use another UserName.');window.location='reg.php'</script>"; exit();
}
?>