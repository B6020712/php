...
<body onload="defaultElements()">
    ...
    <form name='search' action="" method="get">
        <table align="center" width="1100" border="0">
            <tr>
                ...
                <td width="80">
                    <p id="p_1"><select name="type_search" id="type_search" class="select-css" onchange="selectCategory()">
    ...
    <div class="container">
        ...
        <form name="logout_form" method="get" action="logout.php" align="right">
            ...
            <p><a href="order.php?username=<?PHP echo $username; ?>">
                    <font>ประวัติการสั่งซื้อ</font>
                </a></p>
        </form>
        <div class="row">
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <p align="right"><img src="cart.ico" width="30" height="30">
                    <font id="a4">( <?PHP echo $cnt_amount; ?> )</font>
                </p>
                <p align="right"><a href="cart.php?username=<?PHP echo $username ?>&amount=<?PHP echo $cnt_amount; ?> ">
                        <font id="a4">ดูสินค้าในตะกร้า</font>
                    </a></p>
            </div>
        </div>
    </div>
        ...
        if ($_GET['searching'] != '') { // ช่องค้นหาไม่ว่าง
            if (isset($_GET['type_search'])) {
                ...
                if ($_GET['type_search'] == 'gender') {
                    ...
                    $sql = "SELECT * FROM cloth where (gender like '$gender' or gender like 'U') and stock > 0 ORDER by price $type_price";
                }
            }
        ...
        ?>
            <div class="col-sm-4">
                ...
                <p>
                    ...
                    <font id="p_1"><?PHP echo $rs['c_name']; ?></font>
                </p>
                <p>
                ...
                <p>
                    ...
                    <font id="p_1"> <?PHP echo $rs['gender'];
                                    ?></font>
                </p>
                <p>
                ...
                <p>
                    ...
                    <font id="p_1"><?PHP echo $rs['price']; ?>
                        Bath</font>
                </p>
                <p>
                    <font id="a3">Stock: </font>
                    <font id="p_1"><?PHP echo $rs['stock']; ?></font>
                </p>
                <form method="GET" action="addToCart.php">
                    ...
                    <p>
                        ...
                        <font id="p_1"><input type="number" name="amount" placeholder="1" maxlength="3" required min="1" max="100" value="1" /> ea </font>
                    </p>
                    <p>
                        <font id="a3"><button type="submit" id="cart" name="cart" class="btn btnwarning" />Add to Cart</button></font>
                    </p>
                </form>
            </div>
        <?PHP $cnt++;
