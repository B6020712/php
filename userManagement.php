...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <h3 align="right" id="h_3"><a id="h_3" href="adminCostume.php?username=<?PHP echo $username; ?>">Back</a></h3>
            </div>
        </div>
    </div>
    <?PHP
    $sql = "select * from user" or die("Error:");
    ...
    <table width="1150" align="center" border="0">
        ...
        ?>
            <tr>
                <td>
                    <font id="a3"><?PHP echo $rs['user_id']; ?> </font>
                </td>
                <td>
                    <font id="a3"> <?PHP echo $rs['name']; ?> </font>
                </td>
                <td>
                    <font id="a3"> <?PHP echo $rs['username']; ?> </font>
                </td>
                <td>
                    <font id="a3"> <?PHP echo $rs['password']; ?> </font>
                </td>
                <td>
                    <font id="a3"> <?PHP echo $rs['email']; ?> </font>
                </td>
                <td>
                    <font id="a3"> <?PHP echo $rs['status']; ?> </font>
                </td>
                <td><a href="editFormUser.php?user_id=<?PHP echo $rs['user_id']; ?> " id="a2">Edit</td>
