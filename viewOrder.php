...
<body>
    ...
    ?>
    <div class="container">
        <p align="left"> <a href="costume.php"><img src="home.png" width="50" height="50"></a>
        </p>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <h3 align="right" id="h_3"><a id="h_3" href="order.php?username=<?PHP echo $username; ?>">Back</a></h3>
            </div>
        </div>
    </div>
    <?PHP
    ...
    $o_id = $_REQUEST['o_id'];
    $sql = "select * from orders Where o_id = $o_id and username ='$username'" or die("Error: ");
    // $sql = "select * from orders Where o_id = $o_id and username ='$username'" or die("Error:" . mysqli_error());
