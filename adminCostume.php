<?PHP session_start();
if ($_SESSION['userName'] == '' || !$_SESSION['guest'] == '') {
...
<body onload="defaultElements()">
    ...
    <div class="container">
        <form name='search' action="" method="get">
            <table align="center" width="1100" border="0">
                <tr>
                    ...
                    <td align="left">
                        <p align="left" id="p_1"> <button type="submit" />ค้นหา
                            </button></p>
                    </td>
                </tr>
            </table>
        ...
        <p align="right" id="p_1">
            ...
            <!-- Session start living here before moving to top of this document. -->
            <?php 
                if ($_SESSION['user_type'] != "Admin") {
                    echo "<script>alert('Permission Denied!'); window.location='costume.php'</script>";
                    // exit();
                } 
            ?>
        ...
        ?>
            <div class="col-sm-4">
                ...
                <p>
                    ...
                    <font id="p_1"><?PHP echo $rs['gender']; ?></font>
                </p>
                <p>
                ...
                <p>
                    ...
                    <font id="p_1"><?PHP echo $rs['price']; ?>Bath</font>
                </p>
                <p>
                    <font id="a3">Stock:</font>
                    <font id="p_1"><?PHP if ($rs['stock'] < 1) {
                        echo "สินค้าหมด";
                    } else {
                        echo $rs['stock'] . " ea";
                    } ?> </font>
                ...
                <p><a href="editFormCostume.php?c_id=<?PHP echo $rs['c_id']; ?>" id="a2">Edit</a>
                    <a href="delCostume.php?c_id=<?PHP echo $rs['c_id']; ?> " id="a1">Delete</a>
                </p>
            </div>
        <?PHP
            $cnt++;
