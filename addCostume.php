...
window.location='index.html'</script>";
    ...
    <div class="container">
        <form name="addCloth_form" method="post" action="costumeInsert.php" enctype="multipart/form-data">
            <div class="row">
                <div class="col-75">
                    <input type="text" id="ip" name="c_name" placeholder="ชื่อสินค้า" Maxlength="20" required />
                </div>
            </div>
            <div class="row">
                <div class="col-75">
            ...
            <div class="row">
                <div class="col-75">
                    <br>
                    <label id="font">&nbsp;เลือกรูปภาพ: </label><input type="file" name="pic" id="ip" placeholder="รูป" accept="image/*" required />
                </div>
            </div>
            <div class="row">
                <div class="col-75">
            ...
            <div class="row">
                <div class="col-75">
                    <label id="font">&nbsp;สินค้าคงเหลือ (ชิ้น): </label><input type="number" id="font2" name="stock" placeholder="1" maxlength="20" required min="1" max="100" /><br>
                </div>
            </div>
            <div class="row">
                <div class="col-75">
