    ...
    ?>
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
                    <table>
                        <form name="editCloth_form" method="post" action="editCostume.php" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="text" name="c_name" value="<?PHP echo $rs['c_name']; ?>" Maxlength="20" required /> </font>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="text" name="color" value="<?PHP echo $rs['color']; ?>" required />
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="text" name="gender" value="<?PHP echo $rs['gender']; ?>" required />
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="text" name="size" value="<?PHP echo $rs['size']; ?>" required />
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="file" id="pic" name="pic" value="<?PHP $rs['pic']; ?>" accept="image/*" required />
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="text" name="price" value="<?PHP echo $rs['price']; ?>" required /> Bath
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p align="left">
                                        <font id="p_1"><input type="number" name="stock" value="<?PHP echo $rs['stock']; ?>" required min="1" max="100" /> ea
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td width="170">
                                    <p align="left"><button type="submit" class="btn
btn-success btn-lg" />Update Product</button></p>
                                </td>
                                <td>
