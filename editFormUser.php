...
<body>
    ...
    ?>
    <div class="container">
        <p align="left"> <a href="adminCostume.php"><img src="home.png" width="50" height="50"></a>
        </p>
                        ...
                        <table width="800">
                            <form name="editUser_form" method="get" action="editUser.php">
                                <tr>
                                    ...
                                    <td>
                                        <p align="left">
                                            <font id="p_1"><input type="text" name="user_id" Value="<?PHP echo $rs['user_id']; ?>" required />
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p align="left">
                                            <font id="p_1"><input type="text" name="username" Value="<?PHP echo $rs['username']; ?>" required />
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <p align="left">
                                            <font id="p_1"><input type="password" name="password" Value="<?PHP echo $rs['password']; ?>" required />
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p align="left">&nbsp;&nbsp;<a id="h_3" href="userManagement.php">Back</a></p>
                                    </td>
                            </form>
                        </table>
                        <br>
